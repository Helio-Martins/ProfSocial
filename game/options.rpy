...
define config.name = "Pro(f)Social"
#define config.rollback_length = 3
#define config.hard_rollback_limit = 3
...
define build.name = "Pro(f)Social"
...
define config.save_directory = "CyberbullyingTeacherGame-1642866198"
...
init python:
    ...
    config.keymap["rollback"] = None
    config.keymap["rollforward"] = None
    config.keymap["hide_windows"] = None
    config.keymap["launch_editor"] = None
    config.keymap["skip"] = None
    config.keymap["toggle_skip"] = None
    config.keymap["fast_skip"] = None
