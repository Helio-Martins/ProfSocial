...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("Definições") action ShowMenu("preferences")
        ...
        if renpy.variant("pc"):
            ...
            ## Web.
            textbutton _("Sair do Jogo") action Quit(confirm=not main_menu)
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("Página {}"), auto=_("Jogos Guardados Automaticamente"), quick=_("Jogos Guardados Rápidos"))
...
screen preferences():
    ...
    use game_menu(_("Definições"), scroll="viewport"):
